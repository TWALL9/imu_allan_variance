...
def main():
    ...
    parser.add_argument(
        "--data", metavar="STR", type=str, help="TUM data files to plot"
    )
    ...
    yaml_file.write(
        "accelerometer_noise_density: " + repr(worst_accel_white_noise) + " \n"
    )
    yaml_file.write(
        "accelerometer_random_walk: " + repr(worst_accel_random_walk) + " \n"
    )
    yaml_file.write("\n")
